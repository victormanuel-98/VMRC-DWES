...
2.2 Recetas..........................................................................................................................2  
2.3 Ingredientes..................................................................................................................3  
2.4 Planes de Alimentación.................................................................................................3  
2.5 Historial Nutricional.....................................................................................................4  
2.6 Blog y Favoritos............................................................................................................4  
3. Reglas de negocio soportadas.........................................................................................5  

---

### 1. Introducción
La base de datos del proyecto FitFood ha sido diseñada para soportar una aplicación de control nutricional, planificación de dietas y red social de recetas.  
El modelo prioriza la integridad de los datos, la escalabilidad del sistema y la correcta separación de responsabilidades entre entidades.  
...
- Un usuario puede generar múltiples planes de alimentación.  
...
- tiempo_preparacion  
- calorias  
- usuario_id (FK → Usuarios, autor de la receta)  
...
- Una receta puede recibir múltiples puntuaciones de otros usuarios.  
...
- Se permite registrar cantidades específicas de ingredientes para cada receta.  
...
- duracion_dias  
- descripcion  
- usuario_id (FK → Usuarios, creador del plan)  

**Relaciones:**  
- Un plan puede incluir múltiples recetas.  
- Un plan pertenece a un usuario o nutricionista que lo crea.  
...
- fecha  
- calorias_total  
- nutrientes (JSON o tabla relacionada: proteínas, grasas, carbohidratos, vitaminas, etc.)  

**Relaciones:**  
- Un historial pertenece a un usuario.  
- Un historial puede incluir múltiples registros de recetas o ingredientes consumidos en un día.  

---

#### 2.6 Blog y Favoritos
Gestión de la interacción social dentro de la aplicación.  
**Atributos (Recetas en Blog):**  
- id (PK → receta_id)  
...
**Relaciones:**  
- Un usuario puede puntuar varias recetas.  
- Una receta puede recibir varias puntuaciones.  
- Un usuario puede guardar varias recetas en favoritos.  
- Una receta puede estar en favoritos de varios usuarios.

---

### 3. Reglas de negocio soportadas
- Cada usuario debe registrarse para acceder a la aplicación.  
- Solo los nutricionistas pueden crear recetas y planes de alimentación oficiales.  
- Las calorías se calculan automáticamente según la cantidad de cada ingrediente.  
- Un usuario no puede duplicar registros de historial para la misma fecha y comida.  
- Un usuario puede puntuar una receta solo una vez.  
- Los favoritos permiten guardar recetas de otros usuarios para visualización rápida.  

---

### 4. Conclusión
El modelo de datos de FitFood refleja una arquitectura robusta y escalable, preparada para crecimiento y alineada con las funcionalidades del sistema.  
El uso de relaciones claras y entidades especializadas permite mantener integridad, trazabilidad y rendimiento.  
El diseño queda reflejado en el Diagrama ER completo, que representa el núcleo del backend y su interacción con los usuarios, recetas y la información nutricional.
